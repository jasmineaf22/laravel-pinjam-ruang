...
<head>
  ...
  <script src="https://kit.fontawesome.com/0f29ce745c.js" crossorigin="anonymous"></script>
  <!-- Ionicons -->
    ...
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
            <a href="/alur" class="nav-link">
                ...
                <p>Alur <i class="right fas"></i></p>
            </a>
        </li>
        <li class="nav-item">
            <a href="/form" class="nav-link">
                <i class="nav-icon fas fa-edit"></i>
                <p>Form <i class="right fas"></i></p>
            </a>
        </li>
        <li class="nav-item">
            <a href="/" class="nav-link">
                <i class="nav-icon fa-solid fa-table"></i>
                <p>List Peminjaman <i class="right fas"></i></p>
            </a>
        </li>
        <li class="nav-item">
            <a href="/ruangan" class="nav-link">
                <i class="nav-icon fas fa-building"></i>
                <p>Daftar Ruangan <i class="right fas fa-angle-left"></i></p>
            </a>
